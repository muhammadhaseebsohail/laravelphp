        ...
        if(isset($request['username'],$request['password'])){
            ...
            if($user->isValidUser())
            {
                ...
                elseif($user->isSecondaryAdmin()){
                    ...
                    $response['data']['school'] = $user->schoolSecondaryAdminProfile->getResponseData();
                }elseif($user->isResponder()){
                    
                    $response['data']['user'] = $user->responder->getResponseData();
                    $response['data']['school'] = $user->responder->schoolProfile->schoolAdminProfile->getResponseData();
                }
