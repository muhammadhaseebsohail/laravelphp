                        ...
                        <tr> --}}
                            {{-- <td> --}}
                                ...
                                <p class="lead">You’ve been added as a Student to your school’s Waves Network and have been given access
                                    to the Waves App. Having access to the Waves App provides students with the help they
                                    need, when they need it, and helps shorten the distance between students and the office
                                    of student services.
                                </p>
                                ...
                                <p class="lead">
                                    <li>Your Student ID {{ $studentId }} </li>
                                    <li>Your School’s Access Code, which is: {{ $accessCode }} </li>
                                    <li>Your School’s Authorization Code, which is: {{ $authCode }}</li>

                                </p>

                                <p class="lead">Once you select your school and connect to your school’s Waves Network, you wi required to
                                    create a password to protect your account. Once you knock out these initial few steps,
                                    you’re good to go. </p>
